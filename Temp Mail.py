...
while True:
    while True:
        ...
        driver1.find_element_by_xpath("//input[@name='firstname']").send_keys("first")
        driver1.find_element_by_xpath("//input[@name='lastname']").send_keys("last")
        ...
        driver1.find_element_by_xpath("//input[@name='reg_passwd__']").send_keys('password123')
